...
data.forEach(each => {
    articles.appendChild(createArticleComponent(each.firstParagraph, each.secondParagraph, each.thirdParagraph, each.date, each.title))
  })


//define new elements

function createArticleComponent(firstParagraph, secondParagraph, thirdParagraph, date, title) {
